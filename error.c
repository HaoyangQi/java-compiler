...
static java_error_definition* new_error_definitions()
{
    ...
    ERROR_DEFINITION_ENTRY(d, JAVA_E_PART_EXPONENT_OVERFLOW, DEFINE_ERROR(JEL_WARNING, JES_SYNTAX), NULL, "Invalid number: exponent part overflows.");
    ERROR_DEFINITION_ENTRY(d, JAVA_E_PART_INTEGER_OVERFLOW, DEFINE_ERROR(JEL_WARNING, JES_SYNTAX), NULL, "Invalid number: too many digits.");
    ERROR_DEFINITION_ENTRY(d, JAVA_E_LOCAL_VAR_DUPLICATE, DEFINE_SYNTAX_ERROR, NULL, "Duplicated local variable name.");
    ERROR_DEFINITION_ENTRY(d, JAVA_E_LOCAL_VAR_DIM_AMBIGUOUS, DEFINE_SYNTAX_ERROR, NULL, ERR_MSG_DIM_DEF_DIVERGE);
    ERROR_DEFINITION_ENTRY(d, JAVA_E_LOCAL_VAR_DIM_DUPLICATE, DEFINE_ERROR(JEL_WARNING, JES_SYNTAX), NULL, ERR_MSG_DIM_DEF_DUPLICATE);
    ERROR_DEFINITION_ENTRY(d, JAVA_E_LOCAL_VAR_NO_SEMICOLON, DEFINE_SYNTAX_ERROR, ERR_CTX_VAR_DECL, ERR_MSG_MISSING_TOKEN);
